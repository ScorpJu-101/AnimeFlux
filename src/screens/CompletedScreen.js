  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.count}>{completed.length} anime</Text>
      </View>

      {completed.length === 0 ? (
        <View style={styles.emptyContainer}>
          <Feather name="check-circle" size={80} color={COLORS.border} />
          <Text style={styles.emptyText}>No completed anime yet</Text>
          <Text style={styles.emptySubText}>
            Mark anime as completed from the details screen!
          </Text>
        </View>
      ) : (
        <FlatList
